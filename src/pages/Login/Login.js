                        ...
                        <div className="login-container animated fadeInRightBig">
                            ...
                            <form className="form-horizontal" onSubmit={loginUser}>
                                ...
                                <div className="form-group">
                                    <input name='email' disabled={props.auth.loading} onChange={e => setData({ ...data, identifier: e.target.value })} type="email" className="form-control" placeholder="Email Address" required />
                                ...
                                <div className="form-group">
                                    <div className="flexbox align-items-center">
                                        <button disabled={props.auth.loading} type="submit" className="btn theme-bg">{state.loading ? <Spinner color='white' /> : 'log in'}</button>
